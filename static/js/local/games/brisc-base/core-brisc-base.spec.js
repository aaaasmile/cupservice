describe('brisc-base-core test', function () {
  ...
  prepareGame = (rnd_mgr) => {
    ...
    let playerErnesto = new cup.Player(new cup.AlgBriscBase('Ernesto', b2core._deck_info, 'master'), coreStateManager);
    let playerLuigi = new cup.Player(new cup.AlgBriscBase('Luigi', b2core._deck_info), coreStateManager);
