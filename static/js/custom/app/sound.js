...
const _makeSound = makeSound;
export { _makeSound as makeSound };
...
const _loadSound = loadSound;
export { _loadSound as loadSound };
...
const _decodeAudio = decodeAudio;
export { _decodeAudio as decodeAudio };
...
const _soundEffect = soundEffect;
export { _soundEffect as soundEffect };
...
const _impulseResponse = impulseResponse;
export { _impulseResponse as impulseResponse };
